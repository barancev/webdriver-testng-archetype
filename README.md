...
```
mvn archetype:generate -DarchetypeGroupId=ru.stqa.selenium -DarchetypeArtifactId=webdriver-testng-archetype -DarchetypeVersion=4.1 -DgroupId=<mygroupId> -DartifactId=<myartifactId>
```
